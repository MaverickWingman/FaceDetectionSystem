...
public class App {
	...
	public static void main(String[] args) {
		...
		app.loadCascade();//Loading the cascades classifiers
	...
	private void loadCascade() {
		String cascadePath = "D:\\opencv\\build\\etc\\haarcascades\\haarcascade_frontalface_alt.xml";//path for the cascade classifier
